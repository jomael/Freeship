...
uses
  ...
  FreeBulkheadFrm in 'Forms\FreeBulkheadFrm.pas' {FreeBulkheadForm},
  FreeSeakeepingDlg in 'Forms\FreeSeakeepingDlg.pas' {FreeSeakeepingDialog};
...
begin
  ...
  Application.CreateForm(TFreeBulkheadForm, FreeBulkheadForm);
  Application.CreateForm(TFreeSeakeepingDialog, FreeSeakeepingDialog);
  {$IFNDEF CREATE_TRANSLATION}
   ...
   {$IFDEF CREATE_TRANSLATION}
      ...
      FreeBulkheadForm:=TFreeBulkheadForm.Create(Application);
      FreeSeakeepingDialog:=TFreeSeakeepingDialog.Create(Application);
      CreateLanguageFile;
      FreeSeakeepingDialog.Free;
