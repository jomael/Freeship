...
type TFreePrecisionType           = (fpLow,fpMedium,fpHigh,fpVeryHigh);                                  // Precision of the ship-model
     ...
     {---------------------------------------------------------------------------------------------------}
     {                                       TFreeBulkheadElement                                        }
     {                                                                                                   }
     {---------------------------------------------------------------------------------------------------}
     TFreeBulkheadElement   = class
                                 private
                                    FOwner                        : TFreeBulkhead;
                                    FBuild                        : Boolean;
                                    FInnerBoundary                : String;
                                    FOuterBoundary                : String;
                                    FLowerBoundary                : String;
                                    FUpperBoundary                : String;
                                    FItems                        : TFasterList;
                                    function FGetCount:Integer;
                                    function FGetItems(index:Integer):TFreeSpline;
                                    procedure FSetBuild(Val:Boolean);
                                    procedure FSetInnerBoundary(Val:string);
                                    procedure FSetOuterBoundary(Val:string);
                                    procedure FSetLowerBoundary(Val:string);
                                    procedure FSetUpperBoundary(Val:string);
                                 public
                                    procedure   Assign(Element:TFreeBulkheadElement);
                                    procedure   Clear;
                                    constructor Create;
                                    procedure   Delete;
                                    destructor  Destroy;                                  override;
                                    ...
                                    property    Build                : Boolean read FBuild write FSetBuild;
                                    property    Count                : Integer read FGetCount;
                                    property    InnerBoundary        : string read FInnerBoundary write FSetInnerBoundary;
                                    property    Items[index:Integer] : TFreeSpline read FGetItems;
                                    property    LowerBoundary        : string read FLowerBoundary write FSetLowerBoundary;
                                    property    OuterBoundary        : string read FOuterBoundary write FSetOuterBoundary;
                                    property    UpperBoundary        : string read FUpperBoundary write FSetUpperBoundary;
                                    property    Owner                : TFreeBulkhead read FOwner;
                              end;
     {---------------------------------------------------------------------------------------------------}
     {                                       TFreeBulkhead                                               }
     {                                                                                                   }
     ...
     TFreeBulkhead          = class
                                 private
                                    FOwner                        : TFreeShip;
                                    FPosition                     : TFloatType;
                                    FAutoUpdate                   : Boolean;
                                    FVisible                      : Boolean;
                                    FElements                     : TFasterList;
                                    FName                         : String;
                                    function    FGetColor:TColor;
                                    function    FGetCount:Integer;
                                    function    FGetItem(index:Integer):TFreeBulkheadElement;
                                    function    FGetSelected:Boolean;
                                    procedure   FSetAutoUpdate(val:Boolean);
                                    procedure   FSetSelected(val:Boolean);
                                    procedure   FSetName(val:string);
                                    function    FGetPlane:T3DPlane;
                                    procedure   FSetbuild(val:Boolean);
                                    procedure   FSetPosition(val:TFloatType);
                                 public
                                    procedure   AddElement(Element:TFreeBulkheadElement);
                                    procedure   Assign(Bulkhead:TFreeBulkhead);
                                    procedure   Clear;
                                    constructor Create(Owner:TFreeShip);
                                    procedure   Delete;
                                    destructor  Destroy;                                  override;
                                    ...
                                    procedure   Rebuild;
                                    procedure   SaveBinary(Destination:TFreeFileBuffer);
                                    property    AutoUpdate           : boolean read FAutoUpdate write FSetAutoUpdate;
                                    property    Build                : Boolean write fsetbuild;
                                    property    Color                : TColor read FGetColor;
                                    property    Count                : Integer read FGetCount;
                                    property    Items[index:integer] : TFreeBulkheadElement read FGetItem;
                                    property    Name                 : string read FName write FSetName;
                                    property    Owner                : TFreeShip  read FOwner;
                                    property    Plane                : T3DPlane read FGetPlane;
                                    property    Position             : TFloatType read FPosition write FSetPosition;
     ...
     TFreeVisibility     = class(TPersistent)
                                 private
                                    ...
                                    procedure FSetShowBulkheads(Val:Boolean);
                                 ...
                                 published
                                    ...
                                    property    ShowBulkheads                 : Boolean read FShowBulkheads write FSetShowBulkheads;
     ...
     TFreeEdit           = class
                                 ...
                                 public
                                    ...
                                    function Bulkhead_Add:TFreeBulkhead;                                    // Add a new bulkhead
                                    function Bulkhead_AddElement(Bulkhead:TFreeBulkhead):TFreeBulkheadElement;
                                    function Bulkhead_Copy:TFreeBulkhead;                                   // Create a copy of the currebtly active bulkhead
                                    constructor Create(Owner:TFreeShip);
                                    ...
                                    procedure Hydrostatics_Seakeeping;                                      // Opens the seakeeping dialog to start PDStrip
     ...
     TFreePreferences       = class(TPersistent)
                                 private
                                    ...
                                    FPDStripDirectory          : string;   // Path to PDstrip application (open-source seakeeping pogram)
                                    ...
                                    function FGetPDStripDirectory:string;
                                 ...
                                 published
                                    ...
                                    property PDStripDirectory        : string read FGetPDStripDirectory write FPDStripDirectory;
     ...
     {---------------------------------------------------------------------------------------------------}
      TFreeShip             = class(TComponent)
                                 private     { Private declarations }
                                    ...
                                    FBulkheads                 : TFasterList;
                                    FSelectedBulkheads         : TFasterList;
                                    ...
                                    function  FGetBulkhead(Index:integer):TFreeBulkhead;
                                    ...
                                    function  FGetNumberOfBulkheads:integer;
                                    ...
                                    function  FGetSelectedBulkhead(index:Integer):TFreeBulkhead;
                                    ...
                                    function  FGetNumberOfselectedBulkheads:Integer;
                                 ...
                                 public      { Public declarations }
                                    ...
                                    property    Bulkhead[index:integer]                : TFreeBulkhead read FGetBulkhead;
                                    ...
                                    property    NumberofBulkheads                      : integer read FGetNumberOfBulkheads;
                                    ...
                                    property    NumberOfselectedBulkheads              : integer read FGetNumberOfselectedBulkheads;
                                    ...
                                    property    SelectedBulkhead[index:integer]        : TFreeBulkhead read FGetSelectedBulkhead;
         ...
         begin
            ...
            repeat
               ...
               if Displacement<0.1 then Error:=abs(Displacement-CurrDraft.Displ)
                                   else if abs(CurrDraft.Displ)<1e-6 then Error:=0.1+0.1*random
...
{                                                                                                   }
{---------------------------------------------------------------------------------------------------}
function TFreeBulkheadElement.FGetCount:Integer;
begin
   Result:=FItems.Count;
end;{TFreeBulkheadElement.FGetCount}

function TFreeBulkheadElement.FGetItems(index:Integer):TFreeSpline;
begin
   Result:=FItems[index];
end;{TFreeBulkheadElement.FGetItems}

procedure TFreeBulkheadElement.FSetBuild(Val:Boolean);
var I : Integer;
begin
   FBuild:=Val;
   if not Build then
...
end;{TFreeBulkheadElement.FSetBuild}

procedure TFreeBulkheadElement.FSetInnerBoundary(Val:string);
begin
   if Uppercase(Val)<>Uppercase(FInnerBoundary) then
   begin
      FInnerBoundary:=Val;
      Build:=False;
   end;
end;{TFreeBulkheadElement.FSetInnerBoundary}

procedure TFreeBulkheadElement.FSetOuterBoundary(Val:string);
begin
   if Uppercase(Val)<>Uppercase(FOuterBoundary) then
   begin
      FOuterBoundary:=Val;
      Build:=False;
   end;
end;{TFreeBulkheadElement.FSetOuterBoundary}

procedure TFreeBulkheadElement.FSetLowerBoundary(Val:string);
begin
   if Uppercase(Val)<>Uppercase(FLowerBoundary) then
   begin
      FLowerBoundary:=Val;
      Build:=False;
   end;
end;{TFreeBulkheadElement.FSetLowerBoundary}

procedure TFreeBulkheadElement.FSetUpperBoundary(Val:string);
begin
   if Uppercase(Val)<>Uppercase(FUpperBoundary) then
   begin
      FUpperBoundary:=Val;
      Build:=False;
   end;
end;{TFreeBulkheadElement.FSetUpperBoundary}

procedure TFreeBulkheadElement.Clear;
begin
   Build:=False;
   FInnerBoundary:='Shell';
   FOuterBoundary:='Shell';
   FLowerBoundary:='Shell';
   FUpperBoundary:='Shell';
end;{TFreeBulkheadElement.Clear}

procedure TFreeBulkheadElement.Assign(Element:TFreeBulkheadElement);
begin
   Clear;
   FInnerBoundary:=Element.FInnerBoundary;
   FOuterBoundary:=Element.FOuterBoundary;
   FLowerBoundary:=Element.FLowerBoundary;
   FUpperBoundary:=Element.FUpperBoundary;
end;{TFreeBulkheadElement.Assign}

constructor TFreeBulkheadElement.Create;
begin
   Inherited Create;
   FItems:=TFasterList.Create;
   Clear;
end;{TFreeBulkheadElement.Create}

procedure TFreeBulkheadElement.Delete;
var Index:Integer;
begin
   Index:=Owner.FElements.IndexOf(self);
   if Index<>-1 then
   begin
      Owner.FElements.Delete(index);
      Owner.Owner.Redraw;
   end;
end;{TFreeBulkheadElement.Delete}

destructor TFreeBulkheadElement.Destroy;
begin
   Clear;
   FItems.Destroy;
   Inherited Destroy;
end;{TFreeBulkheadElement.Destroy}

function TFreeBulkheadElement.DistanceToCursor(X,Y:Integer;Viewport:TFreeViewport):integer;
var I,Dist:Integer;
begin
   if not build then Rebuild;
   Result:=1000000;
   for I:=1 to Count do
   begin
      Dist:=Items[I-1].DistanceToCursor(X,Y,Viewport);
      if Dist<Result then Result:=Dist;
   end;
end;{TFreeBulkheadElement.DistanceToCursor}

procedure TFreeBulkheadElement.Draw(Viewport:TFreeViewport);
var I:Integer;
   ...
   begin
      ...
      Viewport.PenColor:=RGB(round(0.8*GetRValue(Spline.Color)),
                             round(0.8*GetGValue(Spline.Color)),
                             round(0.8*GetBValue(Spline.Color)));
      Viewport.BrushColor:=Spline.Color;
...
begin
   ...
   for I:=1 to Count do
   begin
      Items[I-1].Fragments:=100;
      Items[I-1].Color:=Owner.Color;
      if Owner.Owner.ActiveBulkhead=Owner then
      begin
         if self=TFreeBulkheadForm(Owner.Owner.FBulkheadForm).ActiveElement then Items[I-1].Color:=clLime;
      end;

      DrawSpline(Items[I-1]);
   end;
end;{TFreeBulkheadElement.Draw}

procedure TFreeBulkheadElement.Extents(Var Min,Max:T3DCoordinate);
begin
   if not build then Rebuild;
end;{TFreeBulkheadElement.Extents}

procedure TFreeBulkheadElement.Rebuild;
var I,J              : Integer;
    ...
    Layer            : TFreeSubdivisionLayer;
    Spline,Mirror    : TFreeSpline;
    InnerValue       : TFloatType;
    OuterValue       : TFloatType;
    LowerValue       : TFloatType;
    UpperValue       : TFloatType;

    function Distance(StringValue:string;ShellValue:TFloatType):TFloatType;
    var Value:TFloatType;
        Flag :Integer;
    begin
       if Uppercase(trim(StringValue))='SHELL' then
       begin
          Result:=ShellValue;
       end else
       begin
          Val(StringValue,Value,Flag);
          if Flag=0 then
          begin
             Result:=Value;
          end else
    ...
    procedure Trim(Spline:TFreeSpline;Plane:T3DPlane);
    // dir=0 ==> trim Y value
    // dir=1 ==? trim Z value
    var Results   : TFreeIntersectionData;
        Params    : TFloatArray;
        NParams   : Integer;
        I,J       : Integer;
        Tmp       : TFreeSpline;
        ...
        Side      : TFloatType;
    begin
       if Spline.NumberOfPoints>2 then
       begin
          Setlength(Params,2);
          Params[0]:=0.0;
          Params[1]:=1.0;
          ...
          if Spline.IntersectPlane(Plane,Results) then
          begin
             Setlength(Params,NParams+Results.NumberOfIntersections);
             for I:=1 to Results.NumberOfIntersections do
             begin
                Params[NParams]:=Results.Parameters[I-1];
                inc(NParams);
             end;
             SortFloatArray(Params,NParams);
          end;
          Tmp:=TFreeSpline.Create;
          for I:=2 to NParams do
          begin
             P:=Spline.Value(0.5*(Params[I-2]+Params[I-1]));
             Side:=Plane.A*P.x+Plane.B*P.y+Plane.C*P.z+Plane.D;
             if Side<=0 then
             begin
                // include this segment
                Tmp.Add(Spline.Value(Params[I-2]));
                Tmp.Knuckle[Tmp.NumberOfPoints-1]:=True;
                for J:=1 to Spline.NumberOfPoints do
                begin
                   if (Spline.Parameter[J-1]>=Params[I-2]) and (Spline.Parameter[J-1]<=Params[I-1]) then
                   begin
                      Tmp.Add(Spline.Point[J-1]);
                      Tmp.Knuckle[Tmp.NumberOfPoints-1]:=Spline.Knuckle[J-1];
                   end;
                end;
                Tmp.Add(Spline.Value(Params[I-1]));
                Tmp.Knuckle[Tmp.NumberOfPoints-1]:=True;
          ...
          Spline.Assign(Tmp);
          Tmp.Destroy;
       end else Spline.Clear;
    end;

begin
   Build:=False;
   Faces:=TFasterList.Create;
   for I:=1 to Owner.Owner.Surface.NumberOfLayers do
   begin
      Layer:=Owner.Owner.Surface.Layer[I-1];
      if Layer.UseForIntersections then for J:=1 to Layer.Count do
      begin
         CtrlFace:=Layer.Items[J-1];
         Min:=CtrlFace.Min;
         Max:=CtrlFace.Max;
         if PlaneIntersectsBox(Min,Max,Owner.Plane) then Faces.Add(CtrlFace);
      end;
   end;
   if Faces.Count>0 then
   begin
      Intersections:=TFasterList.Create;
      Owner.Owner.Surface.CalculateIntersections(Owner.Plane,Faces,Intersections);

      if intersections.Count>0 then
      begin
         Min:=SetPoint( 1e6, 1e6, 1e6);
         Max:=setPoint(-1e6,-1e6,-1e6);
         for I:=Intersections.Count downto 1 do
         begin
            Spline:=Intersections[I-1];
            if Spline.Point[0].Y<>0 then
            begin
               P:=Spline.Point[0];
               P.Y:=0;
               Spline.Insert(0,P);
            ...
            if Spline.Point[Spline.NumberOfPoints-1].Y<>0 then
            begin
            ...
            Mirror:=TFreeSpline.Create;
            Mirror.Assign(Spline);
            Spline.Extents(Min,Max);
            Intersections.Add(Mirror);
            for J:=1 to Mirror.NumberOfPoints do
            begin
               P:=Mirror.Point[J-1];
               P.Y:=-P.Y;
               Mirror.Point[J-1]:=P;
            end;
            Mirror.Extents(Min,Max);
         end;
         JoinSplineSegments(0.01,False,Intersections);

         InnerValue:=Distance(InnerBoundary,1.1*Min.Y);
         OuterValue:=Distance(OuterBoundary,1.1*Max.Y);
         LowerValue:=Distance(LowerBoundary,1.1*Min.Z);
         UpperValue:=Distance(UpperBoundary,1.1*Max.Z);

         for I:=1 to Intersections.Count do
         begin
            Spline:=Intersections[I-1];
            if DistPP3D(Spline.Point[0],Spline.Point[Spline.NumberOfPoints-1])>1e-4 then
            begin
               P:=Spline.Point[0];
               Spline.Add(P);
               Spline.Knuckle[Spline.NumberOfPoints-2]:=True;
            end;
            Trim(Spline,SetPlane(0.0,-1.0,0.0, InnerValue));
            Trim(Spline,SetPlane(0.0, 1.0,0.0,-OuterValue));
            Trim(Spline,SetPlane(0.0,0.0,-1.0, LowerValue));
            Trim(Spline,SetPlane(0.0,0.0, 1.0,-UpperValue));
            if Spline.NumberOfPoints>2 then FItems.Add(Spline)
                                       else Spline.Clear;
         end;
      end;
...
end;{TFreeBulkheadElement.Rebuild}

procedure TFreeBulkheadElement.LoadBinary(Source:TFreeFileBuffer);
var I,J,N,Np: Integer;
    Spline  : TFreeSpline;
    P       : T3DCoordinate;
    Knuckle : Boolean;
begin
   Source.Load(FBuild);
   Source.Load(FInnerBoundary);
   Source.Load(FOuterBoundary);
   Source.Load(FLowerBoundary);
   Source.Load(FUpperBoundary);
   Source.Load(N);
   FItems.Capacity:=N;
   for I:=1 to N do
   begin
      ...
      begin
         ...
         Source.Load(Knuckle);
         Spline.Add(P);
         Spline.Knuckle[J-1]:=Knuckle;
      end;
   end;
end;{TFreeBulkheadElement.LoadBinary}

procedure TFreeBulkheadElement.SaveBinary(Destination:TFreeFileBuffer);
var I,J     : Integer;
    Spline  : TFreeSpline;
begin
   Destination.Add(FBuild);
   Destination.Add(FInnerBoundary);
   Destination.Add(FOuterBoundary);
   Destination.Add(FLowerBoundary);
   Destination.Add(FUpperBoundary);
   Destination.Add(Count);
   for I:=1 to count do
   begin
      Spline:=Items[I-1];
      ...
      for J:=1 to Spline.NumberOfPoints do
      begin
         Destination.Add(Spline.Point[J-1]);
         Destination.Add(Spline.Knuckle[J-1]);
      end;
   end;
end;{TFreeBulkheadElement.SaveBinary}

{---------------------------------------------------------------------------------------------------}
{                                       TFreeBulkhead                                               }
{                                                                                                   }
{---------------------------------------------------------------------------------------------------}
function TFreeBulkhead.FGetColor:TColor;
begin
   if selected then Result:=owner.Preferences.SelectColor
               else Result:=Rgb(150,150,150);
end;{TFreeBulkhead.FGetColor}

function TFreeBulkhead.FGetCount:Integer;
begin
   Result:=FElements.Count;
end;{TFreeBulkhead.FGetCount}

function TFreeBulkhead.FGetSelected:Boolean;
begin
   Result:=Owner.FSelectedBulkheads.SortedIndexOf(self)<>-1;
end;{TFreeBulkhead.FGetSelected}

procedure TFreeBulkhead.FSetAutoUpdate(val:Boolean);
begin
   if val<>FAutoUpdate then
   begin
      Owner.Edit.CreateUndoObject('bulkhead update',True);
      FAutoUpdate:=val;
      Owner.FileChanged:=True;
   end;
end;{TFreeBulkhead.FSetAutoUpdate}

procedure TFreeBulkhead.FSetSelected(val:Boolean);
var Index : Integer;
begin
   Index:=Owner.FSelectedBulkheads.SortedIndexOf(self);
   if Val then
   begin
      // Only add if it is not already in the list
      if Index=-1 then Owner.FSelectedBulkheads.AddSorted(self);
   end else
   begin
      if Index<>-1 then Owner.FSelectedBulkheads.Delete(index);
   end;
   if Assigned(Owner.Surface.OnSelectItem) then Owner.Surface.OnSelectItem(self);
end;{TFreeBulkhead.FSetSelected}

function TFreeBulkhead.FGetItem(index:Integer):TFreeBulkheadElement;
begin
   Result:=FElements[index];
end;{TFreeBulkhead.FGetItem}

procedure TFreeBulkhead.FSetName(val:string);
begin
   if val<>FName then
   begin
      Owner.Edit.CreateUndoObject('bulkhead name',True);
      FName:=val;
      Owner.FileChanged:=True;
   end;
end;{TFreeBulkhead.FSetName}

function TFreeBulkhead.FGetPlane:T3DPLane;
begin
   Result:=setPlane(1.0,0.0,0.0,-FPosition);
end;{TFreeBulkhead.FGetPlane}

procedure TFreeBulkhead.FSetbuild(val:Boolean);
var I:Integer;
begin
   for I:=1 to Count do Items[I-1].Build:=Val;
end;{TFreeBulkhead.FSetbuild}

procedure TFreeBulkhead.FSetPosition(val:TFloatType);
begin
   if abs(Val-FPosition)>1e-4 then
   begin
      Owner.Edit.CreateUndoObject('bulkhead position',True);
      Build:=False;
      FPosition:=Val;
      Owner.SortBulkheads;
      Owner.FileChanged:=True;
   end;
end;{TFreeBulkhead.FSetPosition}

procedure TFreeBulkhead.AddElement(Element:TFreeBulkheadElement);
begin
   FElements.Add(Element);
   Element.FOwner:=self;
   Element.Build:=False;
end;{TFreeBulkhead.AddElement}

procedure TFreeBulkhead.Assign(Bulkhead:TFreeBulkhead);
var I       : Integer;
    Element : TFreeBulkheadElement;
begin
   Clear;
   FPosition:=Bulkhead.FPosition;
   FAutoUpdate:=Bulkhead.FAutoUpdate;
   FVisible:=Bulkhead.FVisible;
   FElements.Capacity:=Bulkhead.Count;
   for I:=1 to Bulkhead.Count do
   begin
      Element:=TFreeBulkheadElement.Create;
      AddElement(Element);
      Element.Assign(Bulkhead.Items[I-1]);
   end;
   Build:=False;
end;{TFreeBulkhead.Assign}

procedure TFreeBulkhead.Clear;
var I:Integer;
begin
   FAutoUpdate:=True;
   FVisible:=True;
   ...
   for I:=1 to Count do Items[I-1].Destroy;
   FElements.Clear;
end;{TFreeBulkhead.Clear}

constructor TFreeBulkhead.Create(Owner:TFreeShip);
begin
   Inherited Create;
   FOwner:=Owner;
   FElements:=TFasterList.Create;
   Clear;
end;{TFreeBulkhead.Create}

procedure TFreeBulkhead.Delete;
var Index : Integer;
begin
   if Self=Owner.ActiveBulkhead then Owner.ActiveBulkhead:=nil;
   Selected:=False;
   Index:=Owner.FBulkheads.IndexOf(self);
   if Index<>-1 then Owner.FBulkheads.Delete(index);
   Destroy;
end;{TFreeBulkhead.Delete}

destructor TFreeBulkhead.Destroy;
begin
   Clear;
   FElements.Destroy;
   Inherited Destroy;
end;{TFreeBulkhead.Destroy}

function TFreeBulkhead.DistanceToCursor(X,Y:Integer;Viewport:TFreeViewport):integer;
var I,Dist:Integer;
begin
   Result:=1000000;
   for I:=1 to Count do
...
end;{TFreeBulkhead.DistanceToCursor}

procedure TFreeBulkhead.Draw(Viewport:TFreeViewport);
var I:Integer;
begin
   for I:=1 to Count do Items[I-1].Draw(Viewport);
end;{TFreeBulkhead.Draw}

procedure TFreeBulkhead.Extents(Var Min,Max:T3DCoordinate);
var I:Integer;
begin
   for I:=1 to Count do Items[I-1].Extents(Min,Max);
end;{TFreeBulkhead.Extents}

procedure TFreeBulkhead.Rebuild;
var I:Integer;
begin
   for I:=1 to Count do Items[I-1].Rebuild;
end;{TFreeBulkhead.Rebuild}

procedure TFreeBulkhead.LoadBinary(Source:TFreeFileBuffer);
var I,N     : Integer;
    Element : TFreeBulkheadElement;
    Bool    : Boolean;
begin
   Source.Load(FName);
   Source.Load(FPosition);
   Source.Load(FAutoUpdate);
   Source.Load(FVisible);
   Source.Load(Bool);
   if Bool then Owner.FSelectedBulkheads.AddSorted(self);
   Source.Load(N);
   FElements.Capacity:=N;
   for I:=1 to N do
   begin
      Element:=TFreeBulkheadElement.Create;
      AddElement(Element);
      Element.LoadBinary(Source);
   end;
end;{TFreeBulkhead.LoadBinary}

procedure TFreeBulkhead.SaveBinary(Destination:TFreeFileBuffer);
var I:Integer;
begin
   Destination.Add(FName);
   Destination.Add(FPosition);
   Destination.Add(FAutoUpdate);
   Destination.Add(FVisible);
   Destination.Add(Selected);
   Destination.Add(Count);
   for I:=1 to Count do Items[I-1].SaveBinary(Destination);
end;{TFreeBulkhead.SaveBinary}
...
procedure TFreeVisibility.FSetShowBulkheads(Val:Boolean);
begin
   if Val<>FShowBulkheads then
   begin
      FShowBulkheads:=val;
      if not FShowBulkheads then Owner.FSelectedBulkheads.Clear;
      Owner.FileChanged:=True;
      if Owner.NumberOfBulkheads>0 then Owner.Redraw;
   end;
end;{TFreeVisibility.FSetShowBulkheads}
      ...
      begin
         ...
         begin
            ...
            begin
               ...
               if Owner.FileVersion>=fv270 then
               begin
                  Source.Load(FShowBulkheads);
               end;
            end;
         end;
      end;
      ...
      begin
         ...
         begin
            ...
            begin
               ...
               if Owner.FileVersion>=fv270 then
               begin
                  Destination.Add(FShowBulkheads);
               end;
            end;
         end;
      end;
...
// Add a new bulkhead
function TFreeEdit.Bulkhead_Add:TFreeBulkhead;
var Bulkhead : TFreeBulkhead;
    Element  : TFreeBulkheadElement;
begin
   CreateUndoObject('Add bulkhead',True);
   Bulkhead:=TFreeBulkhead.Create(Owner);
   Result:=Bulkhead;
   Owner.FBulkheads.Add(Result);
   Element:=TFreeBulkheadElement.Create;
   Result.AddElement(Element);
   Owner.FileChanged:=True;
   Owner.SortBulkheads;
   Owner.Redraw;
   Owner.ActiveBulkhead:=Result;
   TFreeBulkheadForm(Owner.FBulkheadForm).DistBox.SelectAll;
   TFreeBulkheadForm(Owner.FBulkheadForm).DistBox.SetFocus;
end;{TFreeEdit.Bulkhead_Add}

function TFreeEdit.Bulkhead_AddElement(Bulkhead:TFreeBulkhead):TFreeBulkheadElement;
var Element  : TFreeBulkheadElement;
begin
   CreateUndoObject('Add element',True);
   Element:=TFreeBulkheadElement.Create;
   Result:=Element;
   Bulkhead.AddElement(Element);
   Owner.FileChanged:=True;
   Owner.SortBulkheads;
   Owner.Redraw;
   if Owner.ActiveBulkhead=Bulkhead then
   begin
      Owner.ActiveBulkhead:=Bulkhead;
      TFreeBulkheadForm(Owner.FBulkheadForm).Elements.ItemIndex:=TFreeBulkheadForm(Owner.FBulkheadForm).Elements.Count-1;
      TFreeBulkheadForm(Owner.FBulkheadForm).ElementsClick(self);
   end;
end;{TFreeEdit.Bulkhead_AddElement}

// Create a copy of the currebtly active bulkhead
function TFreeEdit.Bulkhead_Copy:TFreeBulkhead;
var Bulkhead : TFreeBulkhead;
begin
   if Owner.ActiveBulkhead<>nil then
   begin
      CreateUndoObject('Add bulkhead',True);
      Bulkhead:=TFreeBulkhead.Create(Owner);
      Result:=Bulkhead;
      Owner.FBulkheads.Add(Result);
      Bulkhead.Assign(Owner.ActiveBulkhead);
      Owner.FileChanged:=True;
      Owner.SortBulkheads;
      Owner.Redraw;
      Owner.ActiveBulkhead:=Result;
...
begin
   ...
   try
      ...
      Owner.FSelectedBulkheads.Clear;
      Owner.Draw;
...
begin
   ...
   begin
      Str:=Userstring(126)+#32+VersionString(Owner.FileVersion)+EOL+
...
// Opens the seakeeping dialog to start PDStrip
procedure TFreeEdit.Hydrostatics_Seakeeping;
var Dialog : TFreeSeakeepingDialog;
begin
   Dialog:=TFreeSeakeepingDialog.Create(Owner);
   ShowTranslatedValues(Dialog);
   Dialog.Draft:=Owner.ProjectSettings.ProjectDraft;
   Dialog.WaterDensity:=Owner.ProjectSettings.ProjectDraft;
   Dialog.WaterDepth:=1e6;
   if Dialog.Execute(Owner) then
   begin
   end;
   Dialog.Destroy;
end;{TFreeEdit.Hydrostatics_Seakeeping}
...
begin
   N:=Owner.NumberOfSelectedControlPoints+
      ...
      Owner.NumberOfselectedBulkheads+
   ...
   begin
      ...
      begin
         ...
         for I:=Owner.NumberOfselectedBulkheads downto 1 do Owner.SelectedBulkhead[I-1].Delete;
...
var I,J:Integer;
begin
   for I:=1 to Owner.NumberOfLayers do if (Owner.Layer[I-1].Visible) and (Owner.Visibility.ShowInteriorEdges) then
   begin
   ...
   for I:=1 to Owner.NumberofBulkheads do Owner.Bulkhead[I-1].Selected:=True;
   Owner.Redraw;
...
function TFreePreferences.FGetPDStripDirectory:string;
begin
   if DirectoryExists(FPDStripDirectory) then result:=FPDStripDirectory
                                         else Result:=ExtractFilePath(Application.ExeName);
end;{TFreePreferences.FGetPDStripDirectory}
...
begin
   ...
   FPDStripDirectory:=ExtractFilePath(Application.ExeName);
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            ShowTranslatedValues(Owner.FControlpointForm);
            ShowTranslatedValues(Owner.FBulkheadForm);
...
begin
   ...
   begin
      ...
      Try
         ...
         if not EOF(FFile) then Readln(FFile,FPDStripDirectory);
         CloseFile(FFile);
      except
...
begin
   ...
   Try
      ...
      Writeln(FFile,FPDStripDirectory);
      CloseFile(FFile);
   except
...
function TFreeShip.FGetSelectedBulkhead(index:Integer):TFreeBulkhead;
begin
   Result:=FSelectedBulkheads[index];
end;{TFreeShip.FGetSelectedBulkhead}
...
function TFreeShip.FGetBulkhead(Index:integer):TFreeBulkhead;
begin
   if (Index>=0) and (Index<FBulkheads.Count) then Result:=FBulkheads[index]
                                              else raise exception.Create('Invalid Bulkhead-index');
end;{TFreeShip.FGetBulkhead}
...
function TFreeShip.FGetNumberOfBulkheads:integer;
begin
   Result:=FBulkheads.Count;
end;{TFreeShip.FGetNumberOfBulkheads}
...
begin
   ...
   begin
      ...
      begin
         ...
         if not FBulkheadForm.Visible then ShowTranslatedValues(FControlpointForm);
         if not FControlpointForm.Visible then ShowWindow(FControlpointForm.Handle, SW_SHOWNOACTIVATE);
...
procedure TFreeShip.FSetActiveBulkhead(val:TFreeBulkhead);
begin
   if Val<>FActiveBulkhead then
   begin
      FActiveBulkhead:=Val;
      TFreeBulkheadForm(FBulkheadForm).ActiveBulkhead:=FActiveBulkhead;
      if FActiveBulkhead=nil then
      begin
         if FBulkheadForm.Visible then FBulkheadForm.Visible:=False;
      end else
      begin
         // The first line makes sure that the form does NOT recieve focus.
         // because the mousewheel zoom in/out doesn't work anymore in that case
         if not FBulkheadForm.Visible then ShowTranslatedValues(FBulkheadForm);
         if not FBulkheadForm.Visible then ShowWindow(FBulkheadForm.Handle, SW_SHOWNOACTIVATE);
         if not FBulkheadForm.Visible then FBulkheadForm.Visible:=true;
      end;
   end else if FActiveBulkhead<>nil then
   begin
      // Update bulkhead information
      TFreeBulkheadForm(FBulkheadForm).ActiveBulkhead:=FActiveBulkhead;
   end;
end;{TFreeShip.FSetActiveBulkhead}
...
begin
   ...
   begin
      ...
      for I:=1 to NumberOfBulkheads do Bulkhead[I-1].Build:=False;
...
function TFreeShip.FGetNumberOfselectedBulkheads:Integer;
begin
   Result:=FselectedBulkheads.Count;
end;{TFreeShip.FGetNumberOfselectedBulkheads}
...
procedure TFreeShip.SortBulkheads;
var I,J:INteger;
begin
   for I:=1 to NumberOfBulkheads-1 do
   begin
      for J:=I+1 to NumberOfBulkheads do if Bulkhead[J-1].Position<Bulkhead[I-1].Position then FBulkheads.Exchange(I-1,J-1);
   end;
end;{TFreeShip.SortBulkheads}
...
begin
   ...
   FBulkheads:=TFasterList.Create;
   FSelectedBulkheads:=TFasterList.Create;
   ClearUndo;
   Clear;
   FControlpointForm:=TFreeControlPointForm.Create(Self);
   FControlpointForm.FreeShip:=self;
   FBulkheadForm:=TFreeBulkheadForm.Create(self);
...
begin
   ...
   FDiagonals.Clear;
   // delete bulkheads
   for I:=1 to NumberOfBulkheads do Bulkhead[I-1].Destroy;
   FBulkheads.Clear;
   FSelectedBulkheads.Clear;
   for I:=1 to NumberOfHydrostaticCalculations do HydrostaticCalculation[I-1].Calculated:=false;
...
begin
   ...
   if Visibility.ShowBulkheads then
   begin
      if (Viewport.Angle>-90) and (Viewport.Angle<90) then for I:=1 to NumberOfBulkheads do Bulkhead[I-1].Draw(Viewport)
                                                      else for I:=NumberOfBulkheads downto 1 do Bulkhead[I-1].Draw(Viewport);
   end;
                  ...
                  begin
                     ...
                     begin
                        ...
                        begin
                           // Load bulkheads
                           Source.Load(N);
                           FBulkheads.Capacity:=N;
                           for I:=1 to N do
                           begin
                              Bulkhead:=TFreeBulkhead.Create(self);
                              FBulkheads.Add(Bulkhead);
                              Bulkhead.LoadBinary(Source);
                           end;
                           SortBulkheads;
                        end;
                     end;
         ...
         begin
            ...
            begin
               ...
               begin
                  ...
                  begin
                     // Save bulkheads
                     Destination.Add(NumberOfBulkheads);
                     for I:=1 to NumberOfBulkheads do Bulkhead[I-1].SaveBinary(Destination);
                  end;
               end;   
            end;
         end;
   ...
   begin
      Case EditMode of
         emSelectItems      : begin
                                 ...
                                 // check Bulkheads
                                 if (Entity=nil) and (not ItemSelected) and (Visibility.ShowBulkheads) then
                                 begin
                                    I:=1;
                                    while I<=NumberOfBulkheads do
                                    begin
                                       Tmp:=Bulkhead[I-1].DistanceToCursor(X,Y,Viewport);
                                       if Tmp<=SelectDistance then
                                       begin
                                          Bulkhead[I-1].Selected:=not Bulkhead[I-1].Selected;
                                          if Bulkhead[I-1].Selected then ActiveBulkhead:=Bulkhead[I-1]
                                                                    else if ActiveBulkhead=Bulkhead[I-1] then ActiveBulkhead:=nil;
                                          ItemSelected:=True;
                                          // Draw the selected Bulkhead to all viewports
                                          for J:=1 to NumberOfViewports do self.Viewport[J-1].Refresh;
                                          break;
                                       end;
                                       Inc(I);
