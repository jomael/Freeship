...
type TMainForm         = class(TForm)
    ...
    AddBulkhead: TAction;
    Addbulkhead1: TMenuItem;
    CopyBulkhead: TAction;
    Bulkheads1: TMenuItem;
    Copy1: TMenuItem;
    Addelement: TAction;
    Addelement1: TMenuItem;
    ShowBulkheads: TAction;
    ToolButton49: TToolButton;
    SeaKeeping: TAction;
    Seakeeping1: TMenuItem;
    ...
    procedure AddBulkheadExecute(Sender: TObject);
    procedure CopyBulkheadExecute(Sender: TObject);
    procedure AddelementExecute(Sender: TObject);
    procedure ShowBulkheadsExecute(Sender: TObject);
    procedure SeaKeepingExecute(Sender: TObject);
...
begin
   ...
   Delete.Enabled:=Freeship.NumberOfSelectedControlPoints+FreeShip.NumberOfSelectedControlEdges+
                   ...
                   Freeship.NumberOfSelectedFlowLines+Freeship.NumberOfselectedMarkers+Freeship.NumberOfselectedBulkheads>0;
   // Window menu actions
   ...
   DeselectAll.Enabled:=(Freeship.NumberOfSelectedControlPoints+FreeShip.NumberOfSelectedControlEdges+Freeship.NumberOfSelectedControlFaces+Freeship.NumberOfSelectedControlCurves+
                         Freeship.NumberOfselectedFlowlines+Freeship.NumberOfselectedMarkers+Freeship.NumberOfselectedBulkheads>0) or
                        (Freeship.ActiveControlPoint<>nil);
   ...
   ShowBulkheads.Checked:=Freeship.Visibility.ShowBulkheads;
   ShowBulkheads.Enabled:=Freeship.NumberOfBulkheads>0;
   ...
   AddBulkhead.Enabled:=FreeShip.Surface.NumberOfControlFaces>0;;
   CopyBulkhead.Enabled:=FreeShip.ActiveBulkhead<>nil;
   // Skip translation
...
procedure TMainForm.AddBulkheadExecute(Sender: TObject);
begin
   Freeship.Edit.Bulkhead_Add;
   UpdateMenu;
end;{TMainForm.AddBulkheadExecute}

procedure TMainForm.CopyBulkheadExecute(Sender: TObject);
begin
   Freeship.Edit.Bulkhead_Copy;
   UpdateMenu;
end;{TMainForm.CopyBulkheadExecute}

procedure TMainForm.AddelementExecute(Sender: TObject);
begin
   if Freeship.ActiveBulkhead<>nil then
   begin
      Freeship.Edit.Bulkhead_AddElement(Freeship.ActiveBulkhead);
      UpdateMenu;
   end;
end;{TMainForm.AddelementExecute}

procedure TMainForm.ShowBulkheadsExecute(Sender: TObject);
begin
   Freeship.Visibility.ShowBulkheads:=not Freeship.Visibility.ShowBulkheads;
   updatemenu;
end;{TMainForm.ShowBulkheadsExecute}

procedure TMainForm.SeaKeepingExecute(Sender: TObject);
begin
   Freeship.Edit.Hydrostatics_Seakeeping;
   UpdateMenu;
end;{TMainForm.SeaKeepingExecute}
